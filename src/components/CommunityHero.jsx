...
const CommunityHero = () => {
  return (
    <section>
      <div className="bg-hero_bg_2 bg-cover bg-no-repeat h-[556px] md:h-[556px] relative mt-5">
        <div className="bg-main_hero absolute top-0 w-full opacity-30 h-full -z-10"></div>
