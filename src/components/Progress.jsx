    ...
    <section className="mt-10">
      <div>
        <div className="flex justify-center mx-auto w-3/5 mb-6 px-6">
          <h2 className="text-main_dark font-cardo font-bold text-5xl leading-[57.6px] text-center ">
            The change we want to see in the world
          </h2>
        </div>
        <div>
          <div className="flex w-full justify-between space-x-10">
            <div className="w-1/3 border-[3px] border-main_text_3 rounded-t-[96px] px-5 pt-5">
